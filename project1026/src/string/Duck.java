...
Object객체이다. 개발자가 상속을 명시하지 않더라도 디폴트로 이미 상속되어 있다. 
*/
class Duck{
	String name="오리";
	...
	아래의 메서드는 Object의 메서드이지만, 테스트로 동작하는 시점을 알기위해 잠시 오버라이드해봤다. 
	*/
	...
	public static void main(String[] args){
		Duck d = new Duck();
		System.out.println(d); //오리 자체가 아니라, 오리의 주소값 :string.Duck@2d363fb3
