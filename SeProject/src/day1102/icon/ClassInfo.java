...
public class ClassInfo {
	...
	public ClassInfo() {
		...
		//사실은 메서드명을 조사하려고 그런게..아니라... 
		//Class클래스를 이용하면, 해당 클래스의 환경정보등도 접근할 수 있다. 따라서 우리는 
		//클래스 패스를 조사해서 우리가 사용중인 res라는 패키지의 경로를 조사할 거야 
		//아래의 메서드를 이용하면, 클래스패스를 기준으로 자원에 접근할 수 있다 
