...
public class ButtonUI extends BasicButtonUI{
	 private static final float arcwidth  = 16.0f;
	  ...
	  @Override public void installListeners(AbstractButton b) {
	  ...
	  public void initShape(JComponent c) {
	  ...
	  public void paintFocusAndRollover(Graphics2D g2, JComponent c, Color color) {
